...
let package = Package(
    ...
    products: [
        .library(name: "CuckooGeneratorFramework",
                 targets: [
                   "CuckooGeneratorFramework",
                   "cuckoo_generator"
                 ]
      ),
      .executable(name: "cuckoo_generator",
                  targets: [
                    "cuckoo_generator"
                  ]
      )
    ...
    dependencies: [
      ...
      .package(url: "https://github.com/flintrocks/FileKitLinux.git", .branch("develop")),
